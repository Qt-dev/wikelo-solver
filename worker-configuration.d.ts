/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: c454cd0f45eba76cc39ec5d0dcd1bf7a)
// Runtime types generated with workerd@1.20260515.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	...
	WIKELO_IMPORT_SECRET: string;
	WIKELO_INTERNAL_TOKEN: string;
	UEX_API_TOKEN: string;
	UEX_ITEMS_PRICES_URL: string;
	UEX_MARKETPLACE_PRICES_URL: string;
	WikeloRepositoryContainer: DurableObjectNamespace /* WikeloRepositoryContainer */;
	UEX_SYNC_WORKFLOW: Workflow /* UexPriceSyncWorkflow */;
	GAME_SYNC_WORKFLOW: Workflow /* GameDataSyncWorkflow */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "WIKELO_IMPORT_SECRET" | "WIKELO_INTERNAL_TOKEN" | "UEX_API_TOKEN" | "UEX_ITEMS_PRICES_URL" | "UEX_MARKETPLACE_PRICES_URL">> {}
}
