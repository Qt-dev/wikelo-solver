...
CREATE INDEX IF NOT EXISTS `recipe_outputs_item_id_idx` ON `recipe_outputs` (`item_id`);
--> statement-breakpoint
INSERT OR IGNORE INTO `recipe_outputs` (`recipe_id`, `sort_order`, `item_id`, `output_name`, `quantity`)
